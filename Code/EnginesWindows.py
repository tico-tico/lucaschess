...
def dicMotoresFixedElo():
    ...
    for nm, option_name, persons in (
            ( "glass", "Personality", (
                                          ...
                                          ("#1200elo", "p: ~1200 elo", 1200),
                                          ("#1400elo", "p: ~1400 elo", 1400),
                                          ("#1600elo", "p: ~1600 elo", 1600),
                                          ("#1800elo", "p: ~1800 elo", 1800),
                                          ("#2000elo", "p: ~2000 elo", 2000),
                                          ("#2200elo", "p: ~2200 elo", 2200),
                                          ("Aggressive", "p: Aggressive / 2300", 2300),
                                          ("Bright", "p: Bright / 2250?", 2250),
                                          ("Careful", "p: Careful / 1900+", 1900),
                                          ("Chimp", "p: Chimp / 800?", 800),
                                          ("Contender", "p: Contender / 2400", 2400),
                                          ("Coward", "p: Coward / 1500+", 1500),
                                          ("Defender", "p: Defender / 2000", 2000),
                                          ("Glass", "p: Glass / 2400", 2400),
                                          ("Gorilla", "p: Gorilla / 800?", 800),
                                          ("Maverick", "p: Maverick / 2000", 2000),
                                          ("Mother", "p: Mother / 1800+", 1800),
                                          ("Nerd", "p: Nerd / 1900", 1900),
                                          ("Ogre", "p: Ogre / 1300", 1300),
                                          ("Punk", "p: Punk / 1800", 1800),
                                          ("Rasta", "p: Rasta / 1600", 1600),
                                          ("Raw", "p: Raw / 1300", 1300),
                                          ("Solid", "p: Solid / 2200", 2200),
                                          ("Useless", "p: Useless / 1000", 1000),
                                      )
            ),
